...
"replaced with mbbill/undotree: Plug 'vim-scripts/Gundo'
...
"replaced with emmet-ls: Plug 'tristen/vim-sparkup'
...
" default value in nvim: set backspace=indent,eol,start

" default value in nvim: set autoindent
" set smartindent
" default value in nvim: set hidden              " allow movement between dirty buffers
...
" default value in nvim: set history=1000        " populate viminfo with command history
" default value in nvim: set ruler               " show the cursor position all the time
...
let g:python3_host_prog = '~/.asdf/installs/python/3.13.3/bin/python'
